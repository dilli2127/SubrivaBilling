...
export const {
  ...
  // Commonly used CRUD hooks (explicitly exported for type safety)
  ...
  // All other CRUD hooks are automatically generated by RTK Query based on createCrudRoutes
  // and are dynamically available as:
