    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, justifyContent: 'space-between', flexWrap: 'wrap', width: '100%' }}>
          {/* Title Section */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, animation: 'fadeInLeft 0.8s ease-out' }}>
            <div style={{
              background: 'linear-gradient(135deg, #3b82f6 0%, #8b5cf6 100%)',
              padding: '12px',
              borderRadius: '50%',
          ...
          {/* Controls Section */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, animation: 'fadeInRight 0.8s ease-out 0.3s both' }}>
            <div style={{ 
              display: 'flex', 
              alignItems: 'center', 
              gap: 10,
              ...
              <Switch
                ...
                style={{
                  backgroundColor: billSettings.isRetail ? '#10b981' : '#3b82f6',
                }}
                size="small"
              />
            </div>
            ...
            <div style={{ 
              ...
              <Switch
                ...
                style={{
                  backgroundColor: billSettings.isGstIncluded ? '#10b981' : '#f59e0b',
                }}
                size="small"
              />
            </div>
            ...
            {!billSettings.isPaid && (
              <div style={{ 
                ...
                <Switch
                  ...
                  style={{
                    backgroundColor: billSettings.isPartiallyPaid ? '#f59e0b' : '#94a3b8',
                  }}
                  size="small"
                />
              </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, animation: 'fadeInUp 0.8s ease-out 0.8s both' }}>
              <div style={{
                background: 'linear-gradient(135deg, #3b82f6 0%, #8b5cf6 100%)',
                padding: '10px 16px',
                borderRadius: '25px',
                ...
                <Text style={{ color: 'white', fontSize: '13px', fontWeight: 700 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <Badge count={billFormData.items.length} showZero size="small" style={{ backgroundColor: 'rgba(255,255,255,0.2)' }}>
              <Text style={{ fontSize: '12px', color: 'white', fontWeight: 700 }}>Items</Text>
            </Badge>
          </div>
